...
class FrontEnd(object):
 ...
 #-----------------Threshold művelet-----------------------------------------------------------------
            #Szürkeskálássá alakítjuk a bejövő képet
            frame = cv2.cvtColor(frame, cv2.COLOR_RGB2GRAY).astype('uint8')
            #A színhű megjelenítéshez megváltoztatjuk a color map-et
            #frame = cv2.applyColorMap(frame,cv2.COLORMAP_BONE)
            #végrehajtuk a threshold műveletet 127-es küszöbérték használatával
